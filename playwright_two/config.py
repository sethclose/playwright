...
class Config:
    def __init__(self, config_df: pd.DataFrame):
        ...
        self.headless:bool = tools.str_to_bool(config_df[config_df['name'] == 'headless']['value'].iloc[0])
        self.trace_mode:bool = tools.str_to_bool(config_df[config_df['name'] == 'trace_mode']['value'].iloc[0])
        self.screenshots: bool = tools.str_to_bool(config_df[config_df['name'] == 'screenshots']['value'].iloc[0])
    ...
    def display(self):
        return (f"  url:  {self.url}\n"
                ...
                f"    platform:{self.platform}  browser(s):{self.browsers} \n"
